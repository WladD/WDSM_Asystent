...
public class ItemVariantStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.ItemVariantAttributeStruct[] attributes;
    ...
    public ItemVariantStruct(
           java.lang.String id,
           int quantity,
           AllegroWebApi.ItemVariantAttributeStruct[] attributes) {
           this.id = id;
     ...
     * @return attributes
     */
    public AllegroWebApi.ItemVariantAttributeStruct[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(AllegroWebApi.ItemVariantAttributeStruct[] attributes) {
        this.attributes = attributes;
    }
