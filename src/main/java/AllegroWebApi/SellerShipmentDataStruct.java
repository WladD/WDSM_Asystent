...
public class SellerShipmentDataStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.SellerPaymentInfoStruct sellerPaymentInfo;

    private int sellerOtherShipmentIsActive;

    private AllegroWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo;
    ...
    public SellerShipmentDataStruct(
           int sellerId,
           AllegroWebApi.SellerPaymentInfoStruct sellerPaymentInfo,
           int sellerOtherShipmentIsActive,
           AllegroWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo) {
     ...
     */
    public AllegroWebApi.SellerPaymentInfoStruct getSellerPaymentInfo() {
        return sellerPaymentInfo;
    }
     ...
     */
    public void setSellerPaymentInfo(AllegroWebApi.SellerPaymentInfoStruct sellerPaymentInfo) {
        this.sellerPaymentInfo = sellerPaymentInfo;
    }
     ...
     */
    public AllegroWebApi.ShipmentPaymentInfoStruct[] getGeneralDeliveryPaymentInfo() {
        return generalDeliveryPaymentInfo;
    }
     ...
     */
    public void setGeneralDeliveryPaymentInfo(AllegroWebApi.ShipmentPaymentInfoStruct[] generalDeliveryPaymentInfo) {
        this.generalDeliveryPaymentInfo = generalDeliveryPaymentInfo;
    }
